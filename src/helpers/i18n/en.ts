export default {
  translation: {
    'Não há eventos adicionados para hoje :)':
      'There are no events added for today :)',
    ...
    'Os campos a seguir estão vazios:': 'The following fields are empty:',
    Título: 'Title',
    'Círculo de urgência': 'circle of urgency',
    'Você adicionou um evento com sucesso! Deseja voltar ao menu principal ou continuar a adicionar?':
      'You have successfully added an event! Do you want to go back to the main menu or continue adding?',
    CONTINUAR: 'CONTINUE',
    VOLTAR: 'BACK',
    'Sem importância': 'Not important',
